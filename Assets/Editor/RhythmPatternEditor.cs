...
public class RhythmPatternEditor : EditorWindow {
    ...
    void OnGUI()
    {
        ...
        if (source)
        {
            ...
            RhythmManager.TriggerTiming timing = sourcePattern.timing;
            sourcePattern.timing = (RhythmManager.TriggerTiming)EditorGUILayout.EnumPopup(("Timing"), timing, GUILayout.MaxWidth(600));
